...
import (
	"bytes"
	"github.com/christiandoxa/welog-v7/pkg/constant/envkey"
	"github.com/christiandoxa/welog-v7/pkg/constant/generalkey"
	"github.com/christiandoxa/welog-v7/pkg/infrastructure/logger"
...
func TestNewFiber(t *testing.T) {
	...
	// Define a route that returns a 200 status code.
